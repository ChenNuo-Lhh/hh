...
public class AliyunUtil {
    ...
    static SendSmsResponse queryPhone(String phoneNumbers, String signName, String templateCode, String templateParam) throws Exception {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4GCGfKpuAGnKA2VLjPwq";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "uib4XBK7MB84BwNHUq6OI1UODgctpm";//你的accessKeySecret，参考本文档步骤2
