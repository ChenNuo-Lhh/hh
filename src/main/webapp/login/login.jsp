    ...
    <script type="text/javascript">
        $(function () {
            $("#loginForm").submit(function () {
                $.post("${pageContext.request.contextPath}/admin/login", $("#loginForm").serialize(), function (res) {
                    if (res.success) {
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" cxlass="captchaImage"
                                     src="${path}/admin/caretImg">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       required type="text" name="enCode" id="form-code">
                            </div>
